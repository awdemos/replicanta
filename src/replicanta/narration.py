...
def _brain_lines(snapshot):
    ...
    return [
        ...
        '  brain.train("digits")      -- alias for brain.run',
        ...
        "",
        "Provenance: the harness is https://github.com/awdemos/rsi-wetware-rs,",
        "a Rust implementation of an L1–L5 recursive-self-improvement loop that",
        "uses the complete larval fruit-fly connectome (Winding et al., Science",
        "2023) as a fixed biological reservoir. Replicanta only spawns and parses it.",
        "",
