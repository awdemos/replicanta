...
def help_text():
    ...
    lines += [
        ...
        "",
        "group: /group start fern willow (or 'all') opens a shared chat;",
        "everything you type is broadcast to every member, and each one",
        "answers in turn. Address a single member with 'fern: …' or",
